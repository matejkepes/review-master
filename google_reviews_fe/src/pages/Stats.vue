            ...
            <div class="row">
              ...
              <div class="col">
                <div class="q-pa-md q-gutter-sm">
                  ...
                  <!-- <q-btn color="secondary" @click="fromLog">From Log</q-btn> -->
                  <q-btn color="secondary" @click="fromFile">From File</q-btn>
...
export default {
  ...
  methods: {
    ...
    // fromLog () {
    //   this.getStats('/auth/statsfromlog')
    // },
    fromFile () {
      this.getStats('/auth/statsfromfile')
    },
    csv () {
      if (this.stats.length > 0) {
        let st = 'ClientID,Client Name,Sent, Group Period'
        for (const s of this.stats) {
          st += '\n'
          st += s.client_id + ',' + s.client_name + ',' + s.sent + ',' + this.formatGroupPeriod(s.group_period)
        }
